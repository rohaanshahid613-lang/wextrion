          ...
          {!showForm ? (
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
              ...
              <div style={{ padding: '16px', background: 'rgba(94,158,244,0.06)', border: '1px solid rgba(94,158,244,0.15)', borderRadius: '10px', textAlign: 'center' }}>
                <p style={{ fontSize: '13px', color: '#7c8099', margin: '0 0 4px', fontFamily: 'Plus Jakarta Sans, sans-serif' }}>Already have an account?</p>
                <Link href="/auth/login" style={{ color: '#5e9ef4', textDecoration: 'none', fontWeight: 600, fontSize: '14px' }}>Sign in →</Link>
              </div>
            </div>
          ) : (
